    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <center><h2>Fazenda $Nome da fazenda</h2></center>
            </div>
            <div class="card-body">
                <a href="/index.php/funcionario/index" role="button" class="btn btn-outline-secondary"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Voltar</a>
